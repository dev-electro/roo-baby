"""
ROO — FastAPI server for Hugging Face Spaces.
Serves Gemma 4 E4B multimodal analysis on GPU.
"""
...
@app.get("/health")
def health():
    return {"status": "ROO online", "model": "gemma-4-E4B-it", "runtime": "Hugging Face Spaces GPU"}
